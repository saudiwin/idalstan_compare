...
mod_list <- c("spline1","spline2","spline3","GP","AR1","RW")

lapply(mod_list, function(m) {
  
  m_loc <- switch(m,
                  spline1="/scratch/rmk7/unemp115_12_1_fit.rds",
                  spline2="/scratch/rmk7/unemp115_12_2_fit.rds",
                  spline3="/scratch/rmk7/unemp115_12_3_fit.rds",
                  GP="/scratch/rmk7/unemp115_12__gp_fit.rds",
                  AR="/scratch/rmk7/unemp115_12_1_ar_fit.rds",
                  RW="/scratch/rmk7/unemp115_12_1_rw_fit.rds")
  ...
  saveRDS(test_mod_pred1, paste0("/scratch/rmk7/unemp_test_pred1_",m,".rds"))
  saveRDS(test_mod_pred2, paste0("/scratch/rmk7/unemp_test_pred2_",m,".rds"))
