...
# Coefficients for Hierarchical Covariates (Main Text Figure 12)

The coefficient values shown in Figure 12 in the main text are shown here in @tbl-coef.
...
readRDS("data/cov_combined.rds") %>% 
  ...
  tt(digits=3,
     notes="Plot shows hierarchical legislator-level covariates for different ideal point models, including time functions and whether or not the model accounted for missingness.") %>%
  style_tt(i=1:36,
           fontsize=.7)
