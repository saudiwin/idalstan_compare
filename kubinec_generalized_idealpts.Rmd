...
unemp1_fit <- id_estimate(unemp1,model_type=2,vary_ideal_pts = 'AR1',niters=300,
                          ...
                          grainsize=floor(length(unique(unemp1@score_matrix$item_id))/parallel::detectCores()),
                          restrict_ind_high = "BARTON, Joe Linus",
                          restrict_ind_low="DeFAZIO, Peter Anthony",
                          restrict_sd_low = 3,
                          fix_low=0,
                          fixtype="prefix",save_files="/scratch/rmk7",
...
unemp2_fit <- id_estimate(unemp2,model_type=2,vary_ideal_pts = 'GP',
                          niters=300,
                          warmup=300,gpu=T,
                          ncores=2,nchain=1,save_files="/scratch/rmk7",
                          fixtype="prefix",
                          restrict_ind_high = "R",
                          restrict_ind_low="D",
                         restrict_sd_low = 3,
