...
# save in non-local folder if in cluster
...
if(cluster) {
  ...
  saveRDS(unemp2_fit,'data/rmk7/unemp2_fit.rds')
  saveRDS(unemp3_fit,'data/rmk7/unemp3_fit.rds')
  ...
  if(cluster) {
    ...
    unemp2_fit <- readRDS('data/unemp2_run1fit.rds')
    unemp3_fit <- readRDS('data/unemp3_run1fit.rds')
    
  } else {
    
    unemp1_fit <- readRDS('/scratch/rmk7/unemp1_run1fit.rds')
    unemp2_fit <- readRDS('/scratch/rmk7/unemp2_run1fit.rds')
    unemp3_fit <- readRDS('/scratch/rmk7/unemp3_run1fit.rds')
...
saveRDS(china_fit1,'data/china_fit1.rds')

china_fit2 <- id_estimate(china_data,model_type=2,
                          vary_ideal_pts = 'splines',
                          niters=300,
                          warmup=300,
                          spline_knots=5,
...
saveRDS(china_fit2,'data/china_fit2.rds')

china_fit3 <- id_estimate(china_data,model_type=2,
                          vary_ideal_pts = 'splines',
                          niters=300,
                          warmup=300,
                          spline_knots=5,
...
saveRDS(china_fit3,'data/china_fit3.rds')
  
} else {
  china_fit1 <- readRDS('data/china_fit1.rds')
  china_fit2 <- readRDS('data/china_fit2.rds')
  china_fit3 <- readRDS('data/china_fit3.rds')
}
