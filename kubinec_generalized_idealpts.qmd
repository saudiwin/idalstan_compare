...
```{r loadmodels,include=FALSE,eval=FALSE}

unemp1_fit <- readRDS('data/unemp115_12_1_fit.rds')
unemp2_fit <- readRDS('data/unemp115_12_2_fit.rds')
unemp3_fit <- readRDS('data/unemp115_12_3_fit.rds')
...
unemp_gp_fit <- readRDS('data/unemp115_12__gp_fit.rds')
unemp_ar_fit <- readRDS("data/unemp115_12_1_ar_fit.rds")
unemp_rw_fit <- readRDS("data/unemp115_12_1_rw_fit.rds")
...
un1_a <- id_plot_legis_dyn(unemp1_fit,include="AMASH, Justin",
                         use_ci=F,plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("Spline of 2nd Degree") + labs(y="") +
  scale_x_date(guide = guide_axis(n.dodge = 2))

un2_a <- id_plot_legis_dyn(unemp2_fit,use_ci=F,include="AMASH, Justin",plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("Spline of 3rd Degree") + labs(y="") +
  scale_x_date(guide = guide_axis(n.dodge = 2))

un3_a <- id_plot_legis_dyn(unemp3_fit,use_ci=F,include="AMASH, Justin",plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("Spline of 4th Degree") + labs(y="") +
  scale_x_date(guide = guide_axis(n.dodge = 2))

gp_a <- id_plot_legis_dyn(unemp_gp_fit,use_ci=F,include="AMASH, Justin",plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("Gaussian Process") + labs(y="") +
  scale_x_date(guide = guide_axis(n.dodge = 2))

ar_a <- id_plot_legis_dyn(unemp_ar_fit,use_ci=F,include="AMASH, Justin",plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("AR(1) Process") + labs(y="") +
  scale_x_date(guide = guide_axis(n.dodge = 2))

rw_a <- id_plot_legis_dyn(unemp_rw_fit,use_ci=F,include="AMASH, Justin",plot_text = F) + scale_color_manual(values=c(R="red",
                              D="blue",I="green"),name="") + ggtitle("Random Walk") +
  scale_x_date(guide = guide_axis(n.dodge = 2)) + labs(y="")
...
s2_cov <- unemp2_fit@stan_samples$draws("legis_x")[,m2,] %>% 
  summarize_draws %>% 
  mutate(Model="Spline 3rd Degree")
s3_cov <- unemp3_fit@stan_samples$draws("legis_x")[,m3,] %>% 
  summarize_draws %>% 
  mutate(Model="Spline 4th Degree")
sgp_cov <- unemp_gp_fit@stan_samples$draws("legis_x")[,mgp,] %>% 
  summarize_draws %>% 
  mutate(Model="Gaussian Process")
sar_cov <- unemp_ar_fit@stan_samples$draws("legis_x")[,mar,] %>% 
  summarize_draws %>% 
  mutate(Model="AR(1)")
srw_cov <- unemp_rw_fit@stan_samples$draws("legis_x")[,mrw,] %>% 
  summarize_draws %>% 
