...
rollcalls %>% 
  ...
  guides(linetype=guide_legend(title="Party"),
         colour=guide_legend(title="Party")) +
...
plot_predictions(c1,condition = "session_day_counter") +
  ...
  labs(y="% Absent by Vote",
       x="Days in Session",
       caption="Plot shows fitted line from OLS polynomial regression on absent rates by number of days into a Congressional session.")
